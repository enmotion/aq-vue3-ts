<template>
	<div ref="container" class="xg1">
		<mce-editor v-if="ismounted" :init="init_" v-model="content" :disabled="disabled" class="xg1 xcol"></mce-editor>
	</div>
</template>
...
require ("./static/plugins/lineheight");//引入行高自定义插件
