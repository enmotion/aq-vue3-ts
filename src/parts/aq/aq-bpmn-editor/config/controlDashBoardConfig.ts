...
const sysMenus:MenuItem[] = [
  ...
  {label:'模拟',tips:'模拟流程',icon:'icon-sumulate',method:{name:'sumulate'}},
];
...
const zoomMenu:MenuItem[] = [
  {tips:'放大',icon:'icon-zoomin',method:{name:'zoom',params:1}},
  {tips:'缩小',icon:'icon-zoomout',method:{name:'zoom',params:-1}},
];
const historyMenu:MenuItem[] = [
  {tips:'后退',icon:'icon-arrowL',method:{name:'jump',params:'prev'}},
  {tips:'前进',icon:'icon-arrowR',method:{name:'jump',params:'next'}},
  {tips:'重绘',icon:'icon-refresh',method:{name:'refresh'}},
];
export default {
  sysMenus,
  alignMenu,
